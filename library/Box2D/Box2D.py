...
b2_invalidParticleIndex = _Box2D.b2_invalidParticleIndex

b2_maxParticleIndex = _Box2D.b2_maxParticleIndex

b2_particleStride = _Box2D.b2_particleStride

b2_minParticleWeight = _Box2D.b2_minParticleWeight

b2_maxParticlePressure = _Box2D.b2_maxParticlePressure

b2_maxParticleForce = _Box2D.b2_maxParticleForce

b2_maxTriadDistance = _Box2D.b2_maxTriadDistance

b2_maxTriadDistanceSquared = _Box2D.b2_maxTriadDistanceSquared

b2_minParticleSystemBufferCapacity = _Box2D.b2_minParticleSystemBufferCapacity

b2_barrierCollisionTime = _Box2D.b2_barrierCollisionTime
...
b2SetAllocFreeCallbacks = _Box2D.b2SetAllocFreeCallbacks
b2SetNumAllocs = _Box2D.b2SetNumAllocs
b2GetNumAllocs = _Box2D.b2GetNumAllocs
b2Log = _Box2D.b2Log
...
b2_liquidFunVersion = b2Globals.b2_liquidFunVersion
...
class b2Vec3(object):
    ...
    Length = _swig_new_instance_method(_Box2D.b2Vec3_Length)
    Normalize = _swig_new_instance_method(_Box2D.b2Vec3_Normalize)
...
class b2Vec4(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(b2Vec4 self) -> b2Vec4
        __init__(b2Vec4 self, float32 x, float32 y, float32 z, float32 w) -> b2Vec4
        """
        _Box2D.b2Vec4_swiginit(self, _Box2D.new_b2Vec4(*args))
    x = property(_Box2D.b2Vec4_x_get, _Box2D.b2Vec4_x_set, doc=r"""x : float32""")
    y = property(_Box2D.b2Vec4_y_get, _Box2D.b2Vec4_y_set, doc=r"""y : float32""")
    z = property(_Box2D.b2Vec4_z_get, _Box2D.b2Vec4_z_set, doc=r"""z : float32""")
    w = property(_Box2D.b2Vec4_w_get, _Box2D.b2Vec4_w_set, doc=r"""w : float32""")
    __swig_destroy__ = _Box2D.delete_b2Vec4

# Register b2Vec4 in _Box2D:
_Box2D.b2Vec4_swigregister(b2Vec4)
...
class b2Transform(object):
    ...
    GetPositionX = _swig_new_instance_method(_Box2D.b2Transform_GetPositionX)
    GetPositionY = _swig_new_instance_method(_Box2D.b2Transform_GetPositionY)
    GetRotationSin = _swig_new_instance_method(_Box2D.b2Transform_GetRotationSin)
    GetRotationCos = _swig_new_instance_method(_Box2D.b2Transform_GetRotationCos)
...
class b2WorldManifold(object):
    ...
    separations = property(_Box2D.b2WorldManifold_separations_get, _Box2D.b2WorldManifold_separations_set, doc=r"""separations : a(2).float32""")
...
B2_INTRUSIVE_LIST_VALIDATE = _Box2D.B2_INTRUSIVE_LIST_VALIDATE

class b2IntrusiveListNode(object):
    r"""Proxy of C++ b2IntrusiveListNode class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(b2IntrusiveListNode self) -> b2IntrusiveListNode"""
        _Box2D.b2IntrusiveListNode_swiginit(self, _Box2D.new_b2IntrusiveListNode())
    __swig_destroy__ = _Box2D.delete_b2IntrusiveListNode
    InsertAfter = _swig_new_instance_method(_Box2D.b2IntrusiveListNode_InsertAfter)
    InsertBefore = _swig_new_instance_method(_Box2D.b2IntrusiveListNode_InsertBefore)
    GetTerminator = _swig_new_instance_method(_Box2D.b2IntrusiveListNode_GetTerminator)
    Remove = _swig_new_instance_method(_Box2D.b2IntrusiveListNode_Remove)
    IsEmpty = _swig_new_instance_method(_Box2D.b2IntrusiveListNode_IsEmpty)
    InList = _swig_new_instance_method(_Box2D.b2IntrusiveListNode_InList)
    GetLength = _swig_new_instance_method(_Box2D.b2IntrusiveListNode_GetLength)
    GetNext = _swig_new_instance_method(_Box2D.b2IntrusiveListNode_GetNext)
    GetPrevious = _swig_new_instance_method(_Box2D.b2IntrusiveListNode_GetPrevious)
    ValidateList = _swig_new_instance_method(_Box2D.b2IntrusiveListNode_ValidateList)
    FindNodeInList = _swig_new_instance_method(_Box2D.b2IntrusiveListNode_FindNodeInList)

# Register b2IntrusiveListNode in _Box2D:
_Box2D.b2IntrusiveListNode_swigregister(b2IntrusiveListNode)

b2_waterParticle = _Box2D.b2_waterParticle

b2_zombieParticle = _Box2D.b2_zombieParticle

b2_wallParticle = _Box2D.b2_wallParticle

b2_springParticle = _Box2D.b2_springParticle

b2_elasticParticle = _Box2D.b2_elasticParticle

b2_viscousParticle = _Box2D.b2_viscousParticle

b2_powderParticle = _Box2D.b2_powderParticle

b2_tensileParticle = _Box2D.b2_tensileParticle

b2_colorMixingParticle = _Box2D.b2_colorMixingParticle

b2_destructionListenerParticle = _Box2D.b2_destructionListenerParticle

b2_barrierParticle = _Box2D.b2_barrierParticle

b2_staticPressureParticle = _Box2D.b2_staticPressureParticle

b2_reactiveParticle = _Box2D.b2_reactiveParticle

b2_repulsiveParticle = _Box2D.b2_repulsiveParticle

b2_fixtureContactListenerParticle = _Box2D.b2_fixtureContactListenerParticle

b2_particleContactListenerParticle = _Box2D.b2_particleContactListenerParticle

b2_fixtureContactFilterParticle = _Box2D.b2_fixtureContactFilterParticle

b2_particleContactFilterParticle = _Box2D.b2_particleContactFilterParticle

class b2ParticleColor(object):
    r"""Proxy of C++ b2ParticleColor class."""
    ...
    def __init__(self, *args):
        r"""
        __init__(b2ParticleColor self) -> b2ParticleColor
        __init__(b2ParticleColor self, uint8 r, uint8 g, uint8 b, uint8 a) -> b2ParticleColor
        __init__(b2ParticleColor self, b2Color color) -> b2ParticleColor
        """
        _Box2D.b2ParticleColor_swiginit(self, _Box2D.new_b2ParticleColor(*args))
    IsZero = _swig_new_instance_method(_Box2D.b2ParticleColor_IsZero)
    GetColor = _swig_new_instance_method(_Box2D.b2ParticleColor_GetColor)
    Set = _swig_new_instance_method(_Box2D.b2ParticleColor_Set)
    __imul__ = _swig_new_instance_method(_Box2D.b2ParticleColor___imul__)
    __mul__ = _swig_new_instance_method(_Box2D.b2ParticleColor___mul__)
    __iadd__ = _swig_new_instance_method(_Box2D.b2ParticleColor___iadd__)
    __add__ = _swig_new_instance_method(_Box2D.b2ParticleColor___add__)
    __isub__ = _swig_new_instance_method(_Box2D.b2ParticleColor___isub__)
    __sub__ = _swig_new_instance_method(_Box2D.b2ParticleColor___sub__)
    __eq__ = _swig_new_instance_method(_Box2D.b2ParticleColor___eq__)
    Mix = _swig_new_instance_method(_Box2D.b2ParticleColor_Mix)
    MixColors = _swig_new_static_method(_Box2D.b2ParticleColor_MixColors)
    r = property(_Box2D.b2ParticleColor_r_get, _Box2D.b2ParticleColor_r_set, doc=r"""r : uint8""")
    g = property(_Box2D.b2ParticleColor_g_get, _Box2D.b2ParticleColor_g_set, doc=r"""g : uint8""")
    b = property(_Box2D.b2ParticleColor_b_get, _Box2D.b2ParticleColor_b_set, doc=r"""b : uint8""")
    a = property(_Box2D.b2ParticleColor_a_get, _Box2D.b2ParticleColor_a_set, doc=r"""a : uint8""")
    __swig_destroy__ = _Box2D.delete_b2ParticleColor

# Register b2ParticleColor in _Box2D:
_Box2D.b2ParticleColor_swigregister(b2ParticleColor)
b2ParticleColor_MixColors = _Box2D.b2ParticleColor_MixColors

class b2ParticleDef(object):
    r"""Proxy of C++ b2ParticleDef class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(b2ParticleDef self) -> b2ParticleDef"""
        _Box2D.b2ParticleDef_swiginit(self, _Box2D.new_b2ParticleDef())
    SetPosition = _swig_new_instance_method(_Box2D.b2ParticleDef_SetPosition)
    SetColor = _swig_new_instance_method(_Box2D.b2ParticleDef_SetColor)
    flags = property(_Box2D.b2ParticleDef_flags_get, _Box2D.b2ParticleDef_flags_set, doc=r"""flags : uint32""")
    position = property(_Box2D.b2ParticleDef_position_get, _Box2D.b2ParticleDef_position_set, doc=r"""position : b2Vec2""")
    velocity = property(_Box2D.b2ParticleDef_velocity_get, _Box2D.b2ParticleDef_velocity_set, doc=r"""velocity : b2Vec2""")
    color = property(_Box2D.b2ParticleDef_color_get, _Box2D.b2ParticleDef_color_set, doc=r"""color : b2ParticleColor""")
    lifetime = property(_Box2D.b2ParticleDef_lifetime_get, _Box2D.b2ParticleDef_lifetime_set, doc=r"""lifetime : float32""")
    group = property(_Box2D.b2ParticleDef_group_get, _Box2D.b2ParticleDef_group_set, doc=r"""group : p.b2ParticleGroup""")
    __swig_destroy__ = _Box2D.delete_b2ParticleDef

# Register b2ParticleDef in _Box2D:
_Box2D.b2ParticleDef_swigregister(b2ParticleDef)

b2CalculateParticleIterations = _Box2D.b2CalculateParticleIterations
class b2ParticleHandle(object):
    r"""Proxy of C++ b2ParticleHandle class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(b2ParticleHandle self) -> b2ParticleHandle"""
        _Box2D.b2ParticleHandle_swiginit(self, _Box2D.new_b2ParticleHandle())
    __swig_destroy__ = _Box2D.delete_b2ParticleHandle
    GetIndex = _swig_new_instance_method(_Box2D.b2ParticleHandle_GetIndex)

# Register b2ParticleHandle in _Box2D:
_Box2D.b2ParticleHandle_swigregister(b2ParticleHandle)
...
class b2Draw(object):
    ...
    e_particleBit = _Box2D.b2Draw_e_particleBit
    ...
    DrawParticles = _swig_new_instance_method(_Box2D.b2Draw_DrawParticles)
...
class b2DrawExtended(b2Draw):
    ...
    __ConvertParCol = _swig_new_instance_method(_Box2D.b2DrawExtended___ConvertParCol)
    __ConvertParCenter = _swig_new_instance_method(_Box2D.b2DrawExtended___ConvertParCenter)
    ...
    DrawParticles = _swig_new_instance_method(_Box2D.b2DrawExtended_DrawParticles)
...
b2_solidParticleGroup = _Box2D.b2_solidParticleGroup

b2_rigidParticleGroup = _Box2D.b2_rigidParticleGroup

b2_particleGroupCanBeEmpty = _Box2D.b2_particleGroupCanBeEmpty

b2_particleGroupWillBeDestroyed = _Box2D.b2_particleGroupWillBeDestroyed

b2_particleGroupNeedsUpdateDepth = _Box2D.b2_particleGroupNeedsUpdateDepth

b2_particleGroupInternalMask = _Box2D.b2_particleGroupInternalMask

class b2ParticleGroupDef(object):
    r"""Proxy of C++ b2ParticleGroupDef class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(b2ParticleGroupDef self) -> b2ParticleGroupDef"""
        _Box2D.b2ParticleGroupDef_swiginit(self, _Box2D.new_b2ParticleGroupDef())
    __swig_destroy__ = _Box2D.delete_b2ParticleGroupDef
    flags = property(_Box2D.b2ParticleGroupDef_flags_get, _Box2D.b2ParticleGroupDef_flags_set, doc=r"""flags : uint32""")
    groupFlags = property(_Box2D.b2ParticleGroupDef_groupFlags_get, _Box2D.b2ParticleGroupDef_groupFlags_set, doc=r"""groupFlags : uint32""")
    position = property(_Box2D.b2ParticleGroupDef_position_get, _Box2D.b2ParticleGroupDef_position_set, doc=r"""position : b2Vec2""")
    angle = property(_Box2D.b2ParticleGroupDef_angle_get, _Box2D.b2ParticleGroupDef_angle_set, doc=r"""angle : float32""")
    linearVelocity = property(_Box2D.b2ParticleGroupDef_linearVelocity_get, _Box2D.b2ParticleGroupDef_linearVelocity_set, doc=r"""linearVelocity : b2Vec2""")
    angularVelocity = property(_Box2D.b2ParticleGroupDef_angularVelocity_get, _Box2D.b2ParticleGroupDef_angularVelocity_set, doc=r"""angularVelocity : float32""")
    color = property(_Box2D.b2ParticleGroupDef_color_get, _Box2D.b2ParticleGroupDef_color_set, doc=r"""color : b2ParticleColor""")
    strength = property(_Box2D.b2ParticleGroupDef_strength_get, _Box2D.b2ParticleGroupDef_strength_set, doc=r"""strength : float32""")
    shape = property(_Box2D.b2ParticleGroupDef_shape_get, _Box2D.b2ParticleGroupDef_shape_set, doc=r"""shape : p.q(const).b2Shape""")
    shapes = property(_Box2D.b2ParticleGroupDef_shapes_get, _Box2D.b2ParticleGroupDef_shapes_set, doc=r"""shapes : p.q(const).p.q(const).b2Shape""")
    shapeCount = property(_Box2D.b2ParticleGroupDef_shapeCount_get, _Box2D.b2ParticleGroupDef_shapeCount_set, doc=r"""shapeCount : int32""")
    stride = property(_Box2D.b2ParticleGroupDef_stride_get, _Box2D.b2ParticleGroupDef_stride_set, doc=r"""stride : float32""")
    particleCount = property(_Box2D.b2ParticleGroupDef_particleCount_get, _Box2D.b2ParticleGroupDef_particleCount_set, doc=r"""particleCount : int32""")
    positionData = property(_Box2D.b2ParticleGroupDef_positionData_get, _Box2D.b2ParticleGroupDef_positionData_set, doc=r"""positionData : p.q(const).b2Vec2""")
    lifetime = property(_Box2D.b2ParticleGroupDef_lifetime_get, _Box2D.b2ParticleGroupDef_lifetime_set, doc=r"""lifetime : float32""")
    group = property(_Box2D.b2ParticleGroupDef_group_get, _Box2D.b2ParticleGroupDef_group_set, doc=r"""group : p.b2ParticleGroup""")
    circleShapes = property(_Box2D.b2ParticleGroupDef_circleShapes_get, _Box2D.b2ParticleGroupDef_circleShapes_set, doc=r"""circleShapes : p.q(const).b2CircleShape""")
    ownShapesArray = property(_Box2D.b2ParticleGroupDef_ownShapesArray_get, _Box2D.b2ParticleGroupDef_ownShapesArray_set, doc=r"""ownShapesArray : bool""")
    FreeShapesMemory = _swig_new_instance_method(_Box2D.b2ParticleGroupDef_FreeShapesMemory)
    SetCircleShapesFromVertexList = _swig_new_instance_method(_Box2D.b2ParticleGroupDef_SetCircleShapesFromVertexList)
    SetPosition = _swig_new_instance_method(_Box2D.b2ParticleGroupDef_SetPosition)
    SetColor = _swig_new_instance_method(_Box2D.b2ParticleGroupDef_SetColor)

# Register b2ParticleGroupDef in _Box2D:
_Box2D.b2ParticleGroupDef_swigregister(b2ParticleGroupDef)

class b2ParticleGroup(object):
    r"""Proxy of C++ b2ParticleGroup class."""
    ...
    __repr__ = _swig_repr
    GetNext = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetNext)
    GetParticleSystem = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetParticleSystem)
    GetParticleCount = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetParticleCount)
    GetBufferIndex = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetBufferIndex)
    ContainsParticle = _swig_new_instance_method(_Box2D.b2ParticleGroup_ContainsParticle)
    GetAllParticleFlags = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetAllParticleFlags)
    GetGroupFlags = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetGroupFlags)
    SetGroupFlags = _swig_new_instance_method(_Box2D.b2ParticleGroup_SetGroupFlags)
    GetMass = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetMass)
    GetInertia = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetInertia)
    GetCenter = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetCenter)
    GetLinearVelocity = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetLinearVelocity)
    GetAngularVelocity = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetAngularVelocity)
    GetTransform = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetTransform)
    GetPosition = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetPosition)
    GetAngle = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetAngle)
    GetLinearVelocityFromWorldPoint = _swig_new_instance_method(_Box2D.b2ParticleGroup_GetLinearVelocityFromWorldPoint)
    ApplyForce = _swig_new_instance_method(_Box2D.b2ParticleGroup_ApplyForce)
    ApplyLinearImpulse = _swig_new_instance_method(_Box2D.b2ParticleGroup_ApplyLinearImpulse)
    DestroyParticles = _swig_new_instance_method(_Box2D.b2ParticleGroup_DestroyParticles)

# Register b2ParticleGroup in _Box2D:
_Box2D.b2ParticleGroup_swigregister(b2ParticleGroup)

B2_FREE_LIST_CHECK_ALLOCATED_ON_FREE = _Box2D.B2_FREE_LIST_CHECK_ALLOCATED_ON_FREE

class b2FreeList(object):
    r"""Proxy of C++ b2FreeList class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(b2FreeList self) -> b2FreeList"""
        _Box2D.b2FreeList_swiginit(self, _Box2D.new_b2FreeList())
    __swig_destroy__ = _Box2D.delete_b2FreeList
    Allocate = _swig_new_instance_method(_Box2D.b2FreeList_Allocate)
    Free = _swig_new_instance_method(_Box2D.b2FreeList_Free)
    AddToFreeList = _swig_new_instance_method(_Box2D.b2FreeList_AddToFreeList)
    RemoveAll = _swig_new_instance_method(_Box2D.b2FreeList_RemoveAll)
    GetAllocatedList = _swig_new_instance_method(_Box2D.b2FreeList_GetAllocatedList)
    GetFreeList = _swig_new_instance_method(_Box2D.b2FreeList_GetFreeList)

# Register b2FreeList in _Box2D:
_Box2D.b2FreeList_swigregister(b2FreeList)

class b2TrackedBlock(object):
    r"""Proxy of C++ b2TrackedBlock class."""
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    GetMemory = _swig_new_instance_method(_Box2D.b2TrackedBlock_GetMemory)
    Allocate = _swig_new_static_method(_Box2D.b2TrackedBlock_Allocate)
    GetFromMemory = _swig_new_static_method(_Box2D.b2TrackedBlock_GetFromMemory)
    Free = _swig_new_static_method(_Box2D.b2TrackedBlock_Free)

# Register b2TrackedBlock in _Box2D:
_Box2D.b2TrackedBlock_swigregister(b2TrackedBlock)
b2_mallocAlignment = b2Globals.b2_mallocAlignment
b2TrackedBlock_Allocate = _Box2D.b2TrackedBlock_Allocate
b2TrackedBlock_GetFromMemory = _Box2D.b2TrackedBlock_GetFromMemory
b2TrackedBlock_Free = _Box2D.b2TrackedBlock_Free

class b2TrackedBlockAllocator(object):
    r"""Proxy of C++ b2TrackedBlockAllocator class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self):
        r"""__init__(b2TrackedBlockAllocator self) -> b2TrackedBlockAllocator"""
        _Box2D.b2TrackedBlockAllocator_swiginit(self, _Box2D.new_b2TrackedBlockAllocator())
    __swig_destroy__ = _Box2D.delete_b2TrackedBlockAllocator
    Allocate = _swig_new_instance_method(_Box2D.b2TrackedBlockAllocator_Allocate)
    Free = _swig_new_instance_method(_Box2D.b2TrackedBlockAllocator_Free)
    FreeAll = _swig_new_instance_method(_Box2D.b2TrackedBlockAllocator_FreeAll)
    GetList = _swig_new_instance_method(_Box2D.b2TrackedBlockAllocator_GetList)

# Register b2TrackedBlockAllocator in _Box2D:
_Box2D.b2TrackedBlockAllocator_swigregister(b2TrackedBlockAllocator)
...
class b2Shape(object):
    ...
    ComputeDistance = _swig_new_instance_method(_Box2D.b2Shape_ComputeDistance)
...
class b2BodyDef(object):
    ...
    SetPosition = _swig_new_instance_method(_Box2D.b2BodyDef_SetPosition)
...
class b2Body(object):
    ...
    GetPositionX = _swig_new_instance_method(_Box2D.b2Body_GetPositionX)
    GetPositionY = _swig_new_instance_method(_Box2D.b2Body_GetPositionY)
...
class b2Fixture(object):
    ...
    ComputeDistance = _swig_new_instance_method(_Box2D.b2Fixture_ComputeDistance)
...
class b2World(object):
    ...
    CreateParticleSystem = _swig_new_instance_method(_Box2D.b2World_CreateParticleSystem)
    DestroyParticleSystem = _swig_new_instance_method(_Box2D.b2World_DestroyParticleSystem)
    Step = _swig_new_instance_method(_Box2D.b2World_Step)
    CalculateReasonableParticleIterations = _swig_new_instance_method(_Box2D.b2World_CalculateReasonableParticleIterations)
    ...
    QueryShapeAABB = _swig_new_instance_method(_Box2D.b2World_QueryShapeAABB)
    ...
    GetParticleSystemList = _swig_new_instance_method(_Box2D.b2World_GetParticleSystemList)
    ...
    GetVersion = _swig_new_instance_method(_Box2D.b2World_GetVersion)
    GetVersionString = _swig_new_instance_method(_Box2D.b2World_GetVersionString)
...
class b2MotorJoint(b2Joint):
    ...
    SetCorrectionFactor = _swig_new_instance_method(_Box2D.b2MotorJoint_SetCorrectionFactor)
    GetCorrectionFactor = _swig_new_instance_method(_Box2D.b2MotorJoint_GetCorrectionFactor)
